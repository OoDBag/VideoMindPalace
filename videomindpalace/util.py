...
def parse_args():
    ...
    # parser.add_argument("--dataset", default='nextqa', type=str)  # 'egoschema', 'nextqa', 'nextgqa', 'intentqa'


    # subset
    parser.add_argument("--data_path", default='./data/egoschema/all_activity_graphs.json', type=str)
    ...
    parser.add_argument("--model", default="gpt-35-turbo", type=str)
