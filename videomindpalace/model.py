    ...
    def get_response(self, **kwargs):
        try:
            ...
            client = AzureOpenAI(
                ...
                azure_endpoint="https://endpoints.openai.azure.com/openai/deployments/gpt-4v/chat/completions?api-version=2024-08-01-preview"
            )
            # res = AzureOpenAI.chat.completions.create(**kwargs)
